...
const TRANSLATIONS = {
  en: {
    ...
    'rules.default':          'Default Rules',
    'rules.customise':        'Customise',
    'rules.grape':            'Grape Variety',
    'rules.grapeDesc':        'Pro-rated by % of correct varietals identified',
    'rules.oldWorld':         'Old / New World',
    'rules.oldWorldDesc':     'Derived from country guess',
  ...
  hk: {
    ...
    'rules.customise':        '自訂',
    'rules.grape':            '提子品種',
    'rules.grapeDesc':        '按估中嘅提子所佔比例計分',
    'rules.oldWorld':         '新 / 舊世界',
    'rules.oldWorldDesc':     '由國家答案推算',
    'rules.country':          '國家',
    'rules.region':           '產區',
    'rules.vintage':          '年份',
    'rules.vintageExact':     '啱晒先算',
    'rules.vintagePlusOne':   '±1年',
    'rules.vintagePlusTwo':   '±2年',
    'rules.abv':              '酒精度',
    'rules.abvDesc':          '5%–20%，每步0.5%',
    'rules.price':            '價格範圍',
